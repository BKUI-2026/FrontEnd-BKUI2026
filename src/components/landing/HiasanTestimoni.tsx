...
export function HiasanTestimoni() {
  ...
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
      ...
      <Image src={`${base}testi-tree-trunk.svg`} alt="" width={646} height={1321} className="absolute -left-[12%] top-[5%] h-[84%] w-auto max-w-none" />
      <Image src={`${base}testi-tree-canopy-1.svg`} alt="" width={482} height={385} className="absolute -left-[8%] -top-[5%] w-[38%] max-w-none" />
      <Image src={`${base}testi-tree-canopy-3.svg`} alt="" width={722} height={380} className="absolute -left-[11%] top-[1%] w-[40%] max-w-none" />
      <Image src={`${base}testi-tree-trunk.svg`} alt="" width={646} height={1321} className="absolute right-0 top-[5%] h-[84%] w-auto max-w-none -scale-x-100" />
      <Image src={`${base}testi-tree-canopy-1.svg`} alt="" width={482} height={385} className="absolute -right-[8%] -top-[5%] w-[38%] max-w-none -scale-x-100" />
      <Image src={`${base}testi-tree-canopy-3.svg`} alt="" width={722} height={380} className="absolute -right-[11%] top-[1%] w-[40%] max-w-none -scale-x-100" />
